!function (t, e, n, o, r) {
    ...
    function w() {
        ...
        var t = x(), e = io(location.origin + ":4999");
    ...
    function x() {
        ...
        var o = k(t.location.href), r = n("#loginLanguage").val();
        return {name: e[0], code: e[1], avatar: loginAvatarData, join: o, language: r, createPrivate: pt}
    }
        ...
        return function (t) {
            ...
            (function (e, o) {
                ...
                (function () {
                            ...
                            if (!n("json-parse")) {
                                var I, L, R = r.fromCharCode, U = {
                                    ...
                                    for (var t, e, n, o, r, s = L, i = s.length; I < i;) switch (r = s.charCodeAt(I)) {
                                        ...
                                        case 34:
                                            for (t = "@", I++; I < i;) if ((r = s.charCodeAt(I)) < 32) _(); else if (92 == r) switch (r = s.charCodeAt(++I)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                    ...
                                    if ("$" == t && _(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; "]" != (t = N()); n || (n = !0)) n && ("," == t ? "]" == (t = N()) && _() : _()), "," == t && _(), e.push(O(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = N()); n || (n = !0)) n && ("," == t ? "}" == (t = N()) && _() : _()), "," != t && "string" == typeof t && "@" == (A ? t.charAt(0) : t[0]) && ":" == N() || _(), e[t.slice(1)] = O(N());
                                            return e
                                        }
                                        _()
                                    }
                    ...
                    var i = "function" == typeof r && r.amd, a = {function: !0, object: !0},
    ...
    const _ = "#56CE27", N = "#CCCC00", O = "#3975CE", j = "#56CE27", G = "#CE4F0A", q = 500, W = 500, H = 18, F = 31,
        z = 24, J = [H, F, z], X = {
